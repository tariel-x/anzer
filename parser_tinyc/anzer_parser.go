...
// AnzerParser rules.
const (
	AnzerParserRULE_program    = 0
	AnzerParserRULE_statement  = 1
	AnzerParserRULE_paren_expr = 2
	AnzerParserRULE_expr       = 3
	AnzerParserRULE_test       = 4
	AnzerParserRULE_sum        = 5
	AnzerParserRULE_term       = 6
	AnzerParserRULE_id         = 7
	AnzerParserRULE_integer    = 8
)
...
func NewEmptyProgramContext() *ProgramContext {
	...
	p.RuleIndex = AnzerParserRULE_program
	return p
}
...
func (p *AnzerParser) Program() (localctx IProgramContext) {
	localctx = NewProgramContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, AnzerParserRULE_program)
	var _la int
	...
	for ok := true; ok; ok = (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<AnzerParserT__0)|(1<<AnzerParserT__2)|(1<<AnzerParserT__3)|(1<<AnzerParserT__4)|(1<<AnzerParserT__5)|(1<<AnzerParserT__7)|(1<<AnzerParserSTRING)|(1<<AnzerParserINT))) != 0) {
		{
			p.SetState(18)
			p.Statement()
		}
...
func (p *AnzerParser) Statement() (localctx IStatementContext) {
	...
	case 5:
		...
		for ((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<AnzerParserT__0)|(1<<AnzerParserT__2)|(1<<AnzerParserT__3)|(1<<AnzerParserT__4)|(1<<AnzerParserT__5)|(1<<AnzerParserT__7)|(1<<AnzerParserSTRING)|(1<<AnzerParserINT))) != 0 {
			{
				p.SetState(44)
				p.Statement()
			}
...
func NewEmptyParen_exprContext() *Paren_exprContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_paren_expr
	return p
}
...
func (p *AnzerParser) Paren_expr() (localctx IParen_exprContext) {
	localctx = NewParen_exprContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, AnzerParserRULE_paren_expr)
...
func NewEmptyExprContext() *ExprContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_expr
	return p
}
...
func (p *AnzerParser) Expr() (localctx IExprContext) {
	localctx = NewExprContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, AnzerParserRULE_expr)
...
func NewEmptyTestContext() *TestContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_test
	return p
}
...
func (p *AnzerParser) Test() (localctx ITestContext) {
	localctx = NewTestContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 8, AnzerParserRULE_test)
...
func NewEmptySumContext() *SumContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_sum
	return p
}
...
func (p *AnzerParser) Sum() (localctx ISumContext) {
	return p.sum(0)
}

func (p *AnzerParser) sum(_p int) (localctx ISumContext) {
	...
	_startState := 10
	p.EnterRecursionRule(localctx, 10, AnzerParserRULE_sum, _p)
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			case 1:
				...
				p.PushNewRecursionContext(localctx, _startState, AnzerParserRULE_sum)
				p.SetState(78)
...
func NewEmptyTermContext() *TermContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_term
	return p
}
...
func (p *AnzerParser) Term() (localctx ITermContext) {
	localctx = NewTermContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 12, AnzerParserRULE_term)
...
func NewEmptyIdContext() *IdContext {
	var p = new(IdContext)
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_id
	return p
}
...
func (p *AnzerParser) Id() (localctx IIdContext) {
	localctx = NewIdContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 14, AnzerParserRULE_id)
...
func NewEmptyIntegerContext() *IntegerContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = AnzerParserRULE_integer
	return p
}
...
func (s *IntegerContext) INT() antlr.TerminalNode {
	return s.GetToken(AnzerParserINT, 0)
}
...
func (p *AnzerParser) Integer() (localctx IIntegerContext) {
	localctx = NewIntegerContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 16, AnzerParserRULE_integer)
	...
	{
		p.SetState(96)
		p.Match(AnzerParserINT)
	}

	return localctx
}

func (p *AnzerParser) Sempred(localctx antlr.RuleContext, ruleIndex, predIndex int) bool {
	switch ruleIndex {
	case 5:
...
func (p *AnzerParser) Sum_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	switch predIndex {
	case 0:
